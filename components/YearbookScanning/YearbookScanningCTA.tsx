...
const YearbookScanningCTA: React.FC = () => {
  const words = ["preserve", "digitize", "protect", "discover"];
        ...
        <div className={`max-w-3xl mx-auto text-center mb-8 sm:mb-10 md:mb-12 transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 text-foreground">
            <div className="flex flex-wrap justify-center items-center gap-x-1 sm:gap-x-2">
              <span>Ready to</span>
              <div
                className="inline-block w-[130px] sm:w-[160px]"
          ...
          <p className="text-foreground/70 text-base sm:text-lg mt-4 sm:mt-6">
            In partnership with Yearbook Scanning Service, your institution gets premium non‑destructive yearbook scanning, searchable digital files, and a clear path to building a modern digital yearbook archive.
          </p>
        </div>
        ...
        <div className={`mt-8 sm:mt-10 md:mt-12 text-center transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              className="bg-gradient-to-r from-blue-400 to-purple-500 text-foreground font-medium rounded-full px-6 sm:px-8 py-2.5 sm:py-3 text-base sm:text-lg transition-all hover:shadow-glow hover:scale-105 active:scale-95 touch-manipulation"
            >
              Request Free Sample Scan
            </a>
          </div>
        </div>
        ...
        <div className={`mt-6 sm:mt-8 text-center transition-all duration-700 delay-400 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <p className="text-foreground/70 text-sm sm:text-base md:text-lg font-medium">
            ...
            <span className="italic">
              Every year, every face, every story—preserved and easy to find.
            </span>
          </p>
        </div>
      </div>
...
export default YearbookScanningCTA;
