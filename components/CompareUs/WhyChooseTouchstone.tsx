  ...
  const highlights = [
    {
      ...
      description: "Rocket Alumni Solutions has a pricing model that is based on an annual basis with an extra charge on multi-screen arrangements. Touchstone, on the other hand, offers annual and one-time pricing with no hidden costs, thereby being a more viable and cost-efficient option to schools, universities and organizations."
    },
    {
      title: "Superior Support & Training",
      description: "Customer success is the main distinction between Touchstone and Rocket Alumni Solutions. Whereas Rocket Alumni Solutions is a video library that is used in the training process, Touchstone provides unlimited live training programs with US-based experts. We have weekly software updates to make sure you are always up to date on the latest features unlike Rocket Alumni solutions which have less frequent updates."
    },
    {
      title: "100% Family-Owned Business",
      description: "Being a 100 percent family business, Touchstone does not focus on profitability in the short-term but on relationships with the family in the long-term. This is used in our complete hardware management service where we will take care of the whole process since it involves ordering until installation which is not obviously indicated in the Rocket Alumni Solutions."
    },
    {
      title: "Innovative Features",
      description: "Touchstone is the best choice as a digital recognition platform whether you are looking to buy Rocket Alumni Solutions or other options since it has a combination of sophisticated features, open pricing, and customer service that is unparalleled. We have unique functionality such as 1-click video background checking, auto image search, clean URLs, which make us different as compared to Rocket Alumni Solutions."
    }
  ];
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            <span className="text-gradient-purple-blue">
              Why Choose Touchstone Over Rocket Alumni Solutions?
            </span>
          </h2>
