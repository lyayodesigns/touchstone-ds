...
const BuiltForInstitutionAndExperience = () => {
  ...
  // Replace all instances of navigate('/path') with router.push('/path') below
  // Example:
  // <button onClick={() => router.push('/some-path')}>Go</button>
  // If you want static links, use <Link href="/some-path">...</Link> instead.
