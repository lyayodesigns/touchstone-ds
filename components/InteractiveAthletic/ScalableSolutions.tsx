...
const ScalableSolutions = () => {
  ...
  const solutions = [
    ...
    },
    {
      ...
      title: "LED Hybrid Installations",
      description: "Cinematic LED walls paired with interactive software, delivering visual impact even when not actively in use.",
      color: "violet"
    },
    {
      icon: <Users className="h-5 w-5" />,
      title: "Multi-User Interactive Hubs",
      description: "Large interactive video walls that support simultaneous users in high-traffic concourse environments.",
      color: "purple"
    },
    {
