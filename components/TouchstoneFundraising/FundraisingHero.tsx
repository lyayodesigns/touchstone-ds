        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <span className="text-transparent bg-clip-text text-gradient-purple-blue">
              Fundraising Made Smarter for Nonprofits, Schools, and Churches
            </span>
          </motion.h1>
          ...
          >
            <p className="text-base md:text-lg text-gray-700 mb-3 md:mb-6 max-w-3xl mx-auto">
              Touchstone Fundraising by Touchstone Digital Solutions gives your organization the tools, strategy, and support it needs to raise more — with less effort.
            </p>
          ...
          >
            <p className="text-base md:text-lg text-gray-700 max-w-3xl mx-auto">
              From nonprofit fundraising events to school fundraising ideas, we power campaigns that inspire giving and drive real results.
            </p>
          </motion.div>
