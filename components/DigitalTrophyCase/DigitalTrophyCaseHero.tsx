          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              <p className="text-base md:text-lg text-gray-700 max-w-3xl mx-auto">
                From dusty shelves to dynamic displays: Celebrate legacies with Touchstone's premier Digital Trophy Case software. Transform your achievements into an interactive, secure, and accessible showcase that tells the complete story of every victory.
              </p>
            </motion.div>
...
export default DigitalTrophyCaseHero;
