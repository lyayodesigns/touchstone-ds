        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <p className="text-base md:text-lg text-gray-700 mb-3 md:mb-6 max-w-3xl mx-auto">
              Honor every legend. Every championship. Every era.
            </p>
          ...
          >
            <p className="text-base md:text-lg text-gray-700 max-w-3xl mx-auto">
              A digital athletic hall of fame that turns your program's history into an interactive experience fans, alumni, and recruits can explore in seconds.
            </p>
          </motion.div>
...
export default AthleticHallOfFameHero;
