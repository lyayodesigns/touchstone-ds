      ...
      <div className="container px-4 md:px-6 mx-auto">
        <div className="text-center mb-16">
          ...
          <motion.h2 
            ...
            viewport={{ once: true }}
          >
            <span className="text-gradient-purple-blue">Transforming</span> Your Recognition System
          </motion.h2>
          <motion.p 
            ...
            viewport={{ once: true }}
          >
            Our simple process makes it easy to implement a digital Hall of Fame that celebrates achievements and inspires your community.
          </motion.p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          >
            ...
            <div className="pt-8">
              ...
              <p className="text-black text-center">
                We'll discuss your needs, space, and vision to create a custom digital recognition solution tailored to your organization's unique requirements.
              </p>
            </div>
          </motion.div>
          {/* Step 2 */}
          ...
          >
            ...
            <div className="pt-8">
              ...
              <p className="text-black text-center">
                Our team handles everything from custom wall wraps to software setup, creating a seamless digital Hall of Fame experience that impresses visitors.
              </p>
            </div>
          </motion.div>
          {/* Step 3 */}
          ...
          >
            ...
            <div className="pt-8">
              ...
              <p className="text-black text-center">
                We'll train your staff on our user-friendly content management system and provide ongoing support to ensure your success for years to come.
              </p>
            </div>
          </motion.div>
        </div>
