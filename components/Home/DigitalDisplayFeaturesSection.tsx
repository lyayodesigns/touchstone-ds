  ...
  const features = [
    {
      ...
      description: <>We design intuitive, easy-to-navigate interfaces that make accessing achievements, stats, and records effortless. Whether exploring a <Link href="/interactive-athletic-environments" className="text-purple-400 hover:text-purple-300 underline underline-offset-2">Hall of Fame</Link>, viewing a <Link href="/digital-record-boards" className="text-purple-400 hover:text-purple-300 underline underline-offset-2">digital record board</Link>, or celebrating team history, our platform ensures a smooth and engaging experience for coaches, players, and fans alike.</>,
      icon: (
