  ...
  return (
    ...
    >
      ...
      <div className="container px-3 sm:px-4 md:px-6 mx-auto relative">
        ...
        <div className={`mt-8 sm:mt-10 md:mt-12 flex flex-col items-center gap-4 transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <button 
