...
const TouchstoneVsGipperComparisonSection: React.FC = () => {
  ...
  const featureCategories = [
    {
      category: "OVERALL",
      features: [
        { name: "Typical Price", touchstone: "$", gipper: "$$", isText: true },
        { name: "100% Family Owned", touchstone: true, gipper: false, rocketNote: "Not specified" },
        { name: "Annual & One-Time Pricing Options", touchstone: "Available", gipper: "Annual only", isText: true },
        { name: "Additional Fees, Including Multi-Screen", touchstone: "No additional fees", gipper: "Additional fees may apply", isText: true },
        { name: "Mobile-Friendly Platform", touchstone: true, gipper: true },
        { name: "QR Code Functionality", touchstone: true, gipper: true },
        { name: "Storage Limits", touchstone: "Unlimited", gipper: "Unlimited", isText: true },
        { name: "Loading Speeds", touchstone: "Fast", gipper: "?", isText: true },
        { name: "24/7/365 Live Support (Text, Call, Email, or On-Site)", touchstone: "Unlimited, US-based support", gipper: "Support hours and location not specified", isText: true },
        { name: "Software Updates", touchstone: "Weekly updates", gipper: "Less frequent updates", isText: true },
        { name: "Content Manager Training", touchstone: "Unlimited, US-based live training", gipper: "Video library & documents only", isText: true },
        { name: "Hardware Ordering", touchstone: "Fully handled by Touchstone", gipper: "Process not specified", isText: true },
        { name: "Unlocking Additional Features", touchstone: "Directly available after demo", gipper: "Process not specified", isText: true }
      ]
    },
    {
      category: "PLATFORM FEATURES",
      features: [
        { name: "Intuitive CMS", touchstone: "Multi-function, user-friendly CMS", gipper: "CMS with similar core functions", isText: true },
        { name: "Premade Templates", touchstone: "50+", gipper: "50+", isText: true },
        { name: "Images", touchstone: true, gipper: true },
        { name: "Videos", touchstone: true, gipper: true },
        { name: "PDFs", touchstone: true, gipper: true },
        { name: "Maps", touchstone: true, gipper: true },
        { name: "Live WYSIWYG", touchstone: true, gipper: true },
        { name: "Drag & Drop Editing", touchstone: true, gipper: true },
        { name: "AI Bulk CSV Upload", touchstone: true, gipper: true },
        { name: "Bulk Image Upload", touchstone: true, gipper: false, rocketNote: "Process not specified" },
        { name: "Social Media Sharing", touchstone: true, gipper: true },
        { name: "1-Click Image Background Removal", touchstone: true, gipper: true },
        { name: "1-Click Video Background Removal", touchstone: true, gipper: false, rocketNote: "Process not specified" },
        { name: "Site-Wide Search", touchstone: true, gipper: true },
        { name: "Automatic Image & Text Searching", touchstone: true, gipper: false, rocketNote: "Process not specified" },
        { name: "Text Filtering", touchstone: true, gipper: true },
        { name: "Image Filtering", touchstone: true, gipper: false, rocketNote: "Process not specified" },
        { name: "Single-Sign On", touchstone: true, gipper: true },
        { name: "Screen Timeout", touchstone: true, gipper: true },
        { name: "Automatic Image Resizing", touchstone: true, gipper: true },
        { name: "Automatic Video Compression", touchstone: true, gipper: true },
        { name: "Automatic PDF Compression", touchstone: true, gipper: true },
        { name: "Media Caching", touchstone: true, gipper: true },
        { name: "Support For All Media Types", touchstone: "MP4, MOV, AVIF, WebP, WebM, MPEG, JPG, PNG, HEIC, SVG, GIF, BMP, ICO, MP3, PDF & more", gipper: "MP4, MOV, AVIF, WebP, WebM, MPEG, JPG, PNG, HEIC, SVG, GIF, BMP, ICO, MP3, PDF & more", isText: true },
        { name: "Custom Domains", touchstone: true, gipper: true },
        { name: "Link Previews", touchstone: true, gipper: true },
        { name: "Animations", touchstone: true, gipper: true },
        { name: "Recently Deleted Bin", touchstone: true, gipper: true }
      ]
    },
    {
      category: "SECURITY & IMPROVEMENTS",
      features: [
        { name: "Automatic Over-The-Air Software Updates", touchstone: true, gipper: true },
        { name: "ADA Accessibility", touchstone: true, gipper: true },
        { name: "Amazon Web Services", touchstone: true, gipper: true },
        { name: "US Based SOC 2 and ISO 27001 Certified Data Centers", touchstone: true, gipper: true },
        { name: "Automatic Content Backups", touchstone: true, gipper: false, rocketNote: "Process not specified" },
        { name: "Remote Access Control", touchstone: true, gipper: false, rocketNote: "Process not specified" },
        { name: "Custom Power On & Off setting", touchstone: true, gipper: true }
      ]
    },
    {
      category: "COMPANY RELATED",
      features: [
        { name: "Graphic Design Team", touchstone: true, gipper: true },
        { name: "Motion Graphic team", touchstone: true, gipper: true },
        { name: "Tutorial Videos & Knowledge Base", touchstone: true, gipper: true },
        { name: "Clean URLS", touchstone: true, gipper: false }
      ]
    }
  ];
  ...
  const keyFeatures = [
    { name: "24/7/365 Support", touchstone: true, gipper: false },
    { name: "Unlimited Training", touchstone: true, gipper: false },
    { name: "Weekly Updates", touchstone: true, gipper: false },
    { name: "Hardware Handling", touchstone: true, gipper: false },
    { name: "Money-Back Guarantee", touchstone: true, gipper: false },
    { name: "No Additional Fees", touchstone: true, gipper: false },
    { name: "Video Background Removal", touchstone: true, gipper: false },
    { name: "Clean URLs", touchstone: true, gipper: true },
    { name: "Mobile Responsive", touchstone: true, gipper: true },
  ];
              ...
              <table className="w-full border-separate border-spacing-0">
                <thead className="sticky top-0 z-20">
                  <tr className="bg-gradient-to-r from-purple-600 to-blue-600 text-white border-b-2 border-white shadow-[0_2px_0_0_#ffffff]">
                    ...
                    <th className="px-4 py-4 text-center font-bold text-lg border-b-2 border-white">gipper</th>
                  </tr>
                </thead>
                <tbody>
                      ...
                      <React.Fragment key={categoryIndex}>
                        ...
                        {category.features.map((feature, index) => (
                          <tr key={`${categoryIndex}-${index}`} className={`border-b border-gray-100 hover:bg-purple-50/50 transition-colors ${
                            ...
                            <td className="px-4 py-3 text-center text-sm">
                              {feature.isText ? (
                                <span className="text-gray-800">{feature.gipper}</span>
                              ) : feature.gipper ? (
                                <div className="inline-flex items-center justify-center w-6 h-6 bg-green-100 rounded-full">
                                  <Check className="h-3 w-3 text-green-600" />
                                </div>
...
export default TouchstoneVsGipperComparisonSection;
