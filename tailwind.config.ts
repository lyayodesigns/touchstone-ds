    ...
    extend: {
      ...
      keyframes: {
        ...
        marquee: {
          ...
          to: { transform: "translateX(calc(-33.33%))" },
        },
      },
      animation: {
        ...
        "ripple-delayed": "ripple-delayed 3s ease-out 1.5s infinite",
      ...
      backgroundImage: {
        ...
        "gradient-spotlight":
          "radial-gradient(circle at center, rgba(120, 80, 255, 0.15) 0%, rgba(0, 0, 0, 0) 70%)",
      },
    },
  },
