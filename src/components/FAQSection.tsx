  ...
  return (
    ...
    >
      ...
      >
        ...
        <svg
          className={`w-5 h-5 md:w-6 md:h-6 text-purple-400 transform transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`}
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
      ...
      >
        <div ref={contentRef} className="p-4 md:p-6 bg-card/50 border-t border-white/10">
  ...
  const faqs: Omit<FAQItemProps, 'isOpen' | 'onClick' | 'index'>[] = [
    {
      ...
      answer: "Unlike traditional recognition displays, our digital hall of fame solutions combine interactive technology with intuitive content management. We specialize in creating customized recognition systems specifically designed for educational institutions, with features like real-time updates, touchscreen interfaces, and seamless integration with existing school systems."
    },
    {
      question: "Which CRM do you integrate with?",
      answer: "Our platform integrates with popular school management systems including PowerSchool, Blackbaud, FACTS SIS, and custom databases. We also offer API connections for specialized systems and can work with your IT team to ensure smooth data flow between your existing infrastructure and our recognition displays."
    },
    {
      question: "Do you have any market restrictions?",
      answer: "We primarily serve K-12 schools, colleges, universities, and educational foundations across North America. While we focus on the education sector, we occasionally work with sports organizations and community centers with similar recognition needs. Contact us to discuss your specific requirements."
    },
    {
      question: "Do you have a mobile app?",
      answer: "Yes, we offer companion mobile apps for both iOS and Android that allow administrators to update content on-the-go. Additionally, we provide responsive web interfaces that work on any device, enabling your community to access your hall of fame content from anywhere."
    },
    {
      question: "What happens if someone calls back the number I'm texting them from?",
      answer: "Our system uses dedicated phone numbers for notifications. If someone calls back, they'll reach our automated system that identifies your institution and provides options to connect with your administrative team or leave a message. This ensures all communication remains professional and properly routed."
    },
    {
      question: "Does the system allow me to export my contacts?",
      answer: "Absolutely. You maintain full ownership of your data and can export contacts, achievements, and media at any time. Our platform includes comprehensive data management tools that allow for scheduled backups, selective exports, and data migration options to ensure your information is always accessible and portable."
    }
  ];
