    ...
    <section className="relative min-h-[80svh] w-full flex flex-col items-center justify-center overflow-hidden pt-16 sm:pt-20 md:pt-32">
      ...
      >
        ...
        >
          ...
          >
            The premier touchscreen recognition experience— the all-in-one solution built to elevate your legacy, captivate your audience, and seamlessly integrate with your brand. Designed for those who demand more than just a display, we transform achievements into immersive, unforgettable experiences.
          </p>
