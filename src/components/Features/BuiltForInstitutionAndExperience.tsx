          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              <div className="relative">
                <motion.div 
                  className="absolute -top-10 -left-10 w-20 h-20 bg-gradient-to-br from-purple-500/10 to-blue-500/10 rounded-full blur-xl"
                  animate={{ 
                    scale: [1, 1.2, 1],
                    opacity: [0.3, 0.6, 0.3],
                  }}
                ...
                >
                  ...
                  <motion.div
                    className="bg-gradient-to-br from-purple-600/10 to-blue-600/10 backdrop-blur-sm border border-white/10 rounded-xl p-6 mb-8"
            ...
            >
              <motion.div 
                className="bg-gradient-to-br from-purple-600/10 to-blue-600/10 backdrop-blur-sm border border-white/10 rounded-xl p-8 relative overflow-hidden"
                whileHover={{ 
