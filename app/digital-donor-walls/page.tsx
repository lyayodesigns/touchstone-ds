...
export const metadata: Metadata = {
  ...
  description: "Touchstone's interactive Digital Donor Walls honor donors at universities, hospitals, and schools. Explore touchscreen recognition examples and pricing.",
  alternates: {
