...
export const metadata: Metadata = {
  ...
  description: 'The 86" Touchstone flagship interactive display for statement installations — oversized PCAP multi-touch, commercial 24/7 operation, and a 3-year warranty.',
  alternates: {
