...
export const metadata: Metadata = {
  ...
  description: 'Explore our 75" interactive display with PCAP touch technology, industrial-grade construction, and comprehensive 3-year warranty for your digital recognition needs.',
  alternates: {
    canonical: 'https://touchstone-ds.com/hardware/75-inch-touchscreen-display/'
  },
  openGraph: {
    title: '75" Interactive Display Hardware | Touchstone Digital Solutions',
    description: 'Explore our 75" interactive display with PCAP touch technology, industrial-grade construction, and comprehensive 3-year warranty for your digital recognition needs.',
    url: 'https://touchstone-ds.com/hardware/75-inch-touchscreen-display/',
    type: 'website',
    images: [{
